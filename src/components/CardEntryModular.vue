...
<template>
    <div class="entry" :class="{ clickable, disabled, compressible }">
        <div class="spacer" :class="{ 'not-mobile-small': compressible }"></div>
        <div class="mugshot" :class="{ lefty, 'not-mobile-small': compressible }">
            <img v-if="img !== null" :src="rebaseUrl(img)" />
        </div>
